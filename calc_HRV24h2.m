function [PwrAR,Estad,alpha]=calc_HRV24h2(data,nmin,Fs,bandes)
%Computes HRV standard time and frequency indices from 24h R-R intervals
% segments default: nmin = 5 min, uses avgpwrAR24h2 
%   (take 5-min from 24-h splines resampled signal for 5-min LF and HF)
%
%[PwrAR,Estad,alpha]= calc_HRV24h2(data,nmin,fs,bands);
%
...
PwrAR=avgpwrAR24h2(data,nmin,Fs,bandes);
