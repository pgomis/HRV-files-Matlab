function [signal_out, perc] = filter22(signal_in, samples, percent)
%%REMOVE ARTIFACTS
%  [fRR, perc] = filter22(RRsignal, muestras, percent)
%
...
% GUIFRE original, using MEDIAN instead of MEAN
...
for i = samples : signal_length
   s_mean = median(signal_in(i-samples+1:i-1));
